...
export function H1({
    children,
    className,
}: IH1Props & React.ComponentProps<"h1">) {
...
export function H2({
    children,
    className,
}: IH2Props & React.ComponentProps<"h2">) {
...
export function H3({
    children,
    className,
}: IH3Props & React.ComponentProps<"h3">) {
...
export function H4({
    children,
    className,
}: IH4Props & React.ComponentProps<"h4">) {
...
export function H5({
    children,
    className,
}: IH5Props & React.ComponentProps<"h5">) {
...
export function H6({
    children,
    className,
}: IH6Props & React.ComponentProps<"h6">) {
