...
class CardapioController extends Controller
{
    ...
    public function update(UpdateCardapioRequest $request, string $cnpj, string $cardapio_id, UpdateCardapioAction $action)
    {
        try {
            ...
            return back()->withErrors(['cardapio' => 'Não foi possivel encontrar o cardápio para atualização dos dados.']);
        } catch (Exception $e) {
            ...
            return back()->withErrors(['cardapio' => 'Não foi possivel atualizar este cardápio, por favor, entrar em contato com o suporte']);
        }
    }
